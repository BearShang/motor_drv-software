...
/* Enable upwind/downwind startup or not */
#ifdef SENSORLESS
//#define WIND_SENSE       /* C46,C47,C48 need to be replaced to 10nF on the AT32M412-LV-MOTOR-EV V1.0 by using voltage sensing */
#endif

/* use back-EMF voltage as voltage input or not */
#ifndef WIND_SENSE
//#define VOLT_SENSE     /* not support in WIND_SENSE mode and C46,C47,C48 need to be replaced to 10nF on the AT32M412-LV-MOTOR-EV V1.0 by using voltage sensing */
#endif
...
#ifndef WIND_SENSE
//#define INIT_ANGLE_STARTUP   /* not support in WIND_SENSE mode */
#endif
#endif
...
/* Id/Iq pid parameter */
#define PID_ID_KP_DEFUALT               (5000)
#define PID_ID_KI_DEFUALT               (4000)
...
#define PID_IQ_KP_DEFUALT               (5000)
#define PID_IQ_KI_DEFUALT               (4000)
