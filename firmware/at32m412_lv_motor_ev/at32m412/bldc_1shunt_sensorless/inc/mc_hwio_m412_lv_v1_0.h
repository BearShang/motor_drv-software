...
/**************** define DEBUG ADC TRIG OUTPUT PIN ******************/
#define DEBUG_TMR_ADC_TRIG_TIMER_CRM_CLK  CRM_TMR3_PERIPH_CLOCK
#define DEBUG_TMR_ADC_TRIG_GPIO_CRM_CLK   CRM_GPIOB_PERIPH_CLOCK
#define DEBUG_TMR_ADC_TRIG_PORT           GPIOB
#define DEBUG_TMR_ADC_TRIG_GPIO_PIN       GPIO_PINS_3
#define DEBUG_TMR_ADC_TRIG_GPIO_PIN_SOURCE GPIO_PINS_SOURCE3
#define DEBUG_TMR_ADC_TRIG_IOMUX          GPIO_MUX_2
/**************** define CMP1 OUT PIN ******************/
